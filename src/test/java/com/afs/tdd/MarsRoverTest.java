...
class MarsRoverTest {
    ...
    @Test
    void should_return_locationX_0_locationY_neg1_direction_S_when_execute_command_given_locationX_0_locationY_0_direction_S_and_M(){
        //given
    ...
    @Test
    void should_return_locationX_neg1_locationY_0_direction_W_when_execute_command_given_locationX_0_locationY_0_direction_W_and_M(){
        //given
    ...
    @Test
    void should_return_locationX_neg1_locationY_1_direction_N_when_execute_command_given_locationX_0_locationY_0_direction_N_and_MLMR(){
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0,0,"MLMR"));
